...
public:
	...
	virtual void notifyPositionUpdate(SceneObject* sceneObject, OctTreeEntry* entry) const {

	}

	virtual void notifySelfPositionUpdate(SceneObject* sceneObject) const;

	virtual void notifyInsert(SceneObject* sceneObject, OctTreeEntry* entry) const {
	}

	virtual void notifyDissapear(SceneObject* sceneObject, OctTreeEntry* entry) const {
	}
