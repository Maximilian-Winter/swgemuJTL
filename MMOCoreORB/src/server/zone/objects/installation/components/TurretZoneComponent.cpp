...
void TurretZoneComponent::notifyInsert(SceneObject* sceneObject, OctTreeEntry* entry) const {
...
void TurretZoneComponent::notifyDissapear(SceneObject* sceneObject, OctTreeEntry* entry) const {
	ManagedReference<SceneObject*> target = cast<SceneObject*>(entry);
